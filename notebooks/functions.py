...
def count_words(input_list: list, verbose = False) -> dict:
    '''
    Takes in a List of String and returns a dictionary containing the number of occurences for each word.

    Parameters: 

    input_list - Array-like object containing a list of words to count. 

    verbose - A boolean option to determine if you would like a loading bar.  
    '''
    word_counts = {}
    # Iterate through list of headlines
    for headline in tqdm.tqdm(input_list, disable = verbose):
